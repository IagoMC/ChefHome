...
alter table  Comentarios add foreign key(idUsuario) references Ususarios(id);
...
alter table  Publicacion add foreign key(idCreador) references Ususarios(id);

alter table  Seguidores add foreign key(idUsuario) references Ususarios(id);
alter table  Seguidores add foreign key(idSeguido) references Ususarios(id);


insert into Ususarios (id,Nombre,Email,Contraseña) values (1,"Iago", "im@gmail.com" , "1234");
